...
public class APITask extends AsyncTask<Object, Void, APITask.APIResult> {
	...
	public class APIResult {
		...
		String status;
		String content;
		List<? extends APIData> dataList;	// for list
		APIData data;						// for read
	...
	protected void onPostExecute(APIResult result) {
		...
		case LIST:
			...
			case SHOPPER_ACCOUNT:
				Type listType = new TypeToken<List<ShopperAccount>>(){}.getType();
				result.dataList = (List<ShopperAccount>) gson.fromJson(result.content, listType);
				break;
			}
			break;
		case READ:
