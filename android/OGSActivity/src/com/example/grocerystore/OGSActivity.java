...
public class OGSActivity extends Activity implements OnClickListener, APITask.Callback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnListProducts = (Button) findViewById(R.id.button_list_products);
	...
	public void onClick(View from) {
		...
		case R.id.button_get_shopper:
			testGetShopper();
			break;
		case R.id.button_list_products:
			testListProducts();
			break;
		}
	}
