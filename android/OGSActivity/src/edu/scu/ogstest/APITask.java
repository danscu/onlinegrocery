...
import com.example.grocerystore.OGSActivity;
import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;

import edu.scu.ogstest.APITask.WhatToAccess;
...
public class APITask extends AsyncTask<Object, Void, APITask.APIResult> {
	...
	protected BrowseActivity callback;
	protected Gson gson = new Gson();
	
	/**
	 * Access to database (CRUDL)
	 * @param what		Which table to access
	 * @param mainActivity		Callback interface to receive API status and result
	 */
	public APITask(WhatToAccess what, BrowseActivity mainActivity) {
		this.what = what;
		this.callback = mainActivity;
	}

	public APITask(WhatToAccess shopperAccount, OGSActivity ogsActivity) {
		// TODO Auto-generated constructor stub
	}

	public APITask(WhatToAccess shopperAccount, MainActivity mainActivity) {
		// TODO Auto-generated constructor stub
	}
