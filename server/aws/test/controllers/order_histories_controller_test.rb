...
class OrderHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create order_history" do
    assert_difference('OrderHistory.count') do
      post :create, order_history: { itemID: @order_history.itemID, pricePerUnit: @order_history.pricePerUnit, quantity: @order_history.quantity }
    end
  ...
  test "should update order_history" do
    patch :update, id: @order_history, order_history: { itemID: @order_history.itemID, pricePerUnit: @order_history.pricePerUnit, quantity: @order_history.quantity }
    assert_redirected_to order_history_path(assigns(:order_history))
  end
